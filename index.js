...
const script = {
    init: (nameFolder) => {
        ...
        setTimeout(() => { script.readFile(name); }, 1000);
    },
    ...
    executCommand: (nameFolder) => {
        fs.opendir(nameFolder, (err, dir) => {
            ...
            exec(`cd ${dir.path}/ && npm init -y && npm i express && npm i ejs && npm i dotenv`);

            console.log('Folders and files successfully created!');
          dir.closeSync();
        }
      })
    },
